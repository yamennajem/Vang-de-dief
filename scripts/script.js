...
// Geluids effecten
const backgroundMuziek = document.querySelector('#backgroundmuziekje')
const goeddMuziek = document.querySelector('#goedmuziekje')
const foutMuziek = document.querySelector('#foutmuziekje')
